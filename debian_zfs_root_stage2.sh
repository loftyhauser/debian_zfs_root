...
echo "deb-amd64 http://mirrors.kernel.org/debian/ stretch-updates main contrib non-free" >> /etc/apt/sources.list
echo "deb-src http://mirrors.kernel.org/debian/ stretch-updates main contrib non-free" >> /etc/apt/sources.list
echo "deb-amd64 http://mirrors.kernel.org/debian/ stretch-backports main contrib non-free" >> /etc/apt/sources.list
echo "deb-src http://mirrors.kernel.org/debian/ stretch-backports main contrib non-free" >> /etc/apt/sources.list
